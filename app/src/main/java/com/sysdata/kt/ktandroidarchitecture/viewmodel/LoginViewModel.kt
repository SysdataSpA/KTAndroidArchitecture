...
class LoginViewModel: BaseViewModel() {
    ...
    //action to launch a usecase that simulate a login
    ...
    // definition of the datasource channel, used by the paged list
    val channelNotes = DataSourceChannel.Builder<Int, Note>()
            .dataSource(TestDataSource::class.java)
            .build()

    // base channel used to post and recieve datas
